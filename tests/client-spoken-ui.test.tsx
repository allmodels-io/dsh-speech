...
function scope(autoPlay = true) {
  const set = vi.fn(async () => {})
  const snapshot = { status: 'ready' as const, value: { autoPlay }, base: {}, user: {}, revision: 1, writable: true, mode: 'host' as const }
  return {
    set,
    value: {
...
function renderAction(state: SpokenMessageState) {
